...
This project is an extremely thin wrapper over the https://github.com/conventional-changelog/conventional-changelog/blob/master/packages/conventional-changelog-conventionalcommits/ package, 
to include custom commit types that Meza uses in his projects, and to provide a default configuration for semantic-release users.

We use typescript to write the code and `corepack pnpm` to manage dependencies and scripts.
